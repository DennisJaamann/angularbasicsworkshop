(function () {
  ...
  angular.module('tweets')
    .service('TwitterSearchService', function twitterSearchService($log,$resource) {
      ...
      var twitterSearchResource = $resource('https://twitter.com/search?q=:searchTerm',{ searchTerm: '@searchTerm'}, {}); //TODO: 7. Create a new resource with url https://twitter.com/search?q=:searchTerm
